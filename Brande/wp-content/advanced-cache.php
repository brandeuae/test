...
$nitropack_functions_file = '/home/brande/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/brande/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_8896ee582ace215b41fe185c2faf4a64' );
